...
if (isset($_POST['signup-btn'])) {
    ...
    if (count($errors) === 0) {
        ...
        if ($stmt->execute()) {
            ...
            $verfication_URL  = 'http://localhost/e-solution/singin-signup/user/controllers/verify.php?code=' . $token;
...
if (isset($_POST['forgot-password'])) {
    ...
    if (count($errors) == 0){
        ...
        $token = $user['token'];
            ...
            $verification_code = sha1($email . time());
            $verfication_URL  = 'http://localhost/e-solution/singin-signup/user/index.php?password-token=' . $token;
